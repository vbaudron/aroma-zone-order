# Generated by Django 3.0.5 on 2020-07-02 06:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('density', models.DecimalField(decimal_places=2, default=None, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('ml_to_goutte', models.PositiveSmallIntegerField(default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('unit', myapp.models.MeasurementUnitFields(choices=[(0, 'None'), (1, 'Ml'), (2, 'Grams'), (3, 'Goutte'), (4, 'Masque')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('_quantity', models.DecimalField(decimal_places=2, max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('unit', myapp.models.MeasurementUnitFields(choices=[(0, 'None'), (1, 'Ml'), (2, 'Grams'), (3, 'Goutte'), (4, 'Masque')], default=0)),
